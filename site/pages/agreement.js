...
const Agreement = () => (
  <Page>
    <div className="container">
      ...
      <section>
        4. Благодійник дає згоду на перерозподіл/використання надлишкових коштів від Благодійної пожертви
        у випадку завершення краудфандингової кампанії підтриманого проекту
        на інші проекти Організації, які втілюються без комерційної мети.
      </section>
    </div>
    <style jsx>
      {
